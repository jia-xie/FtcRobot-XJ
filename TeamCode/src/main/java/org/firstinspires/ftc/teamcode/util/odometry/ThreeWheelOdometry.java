...
public class ThreeWheelOdometry implements Runnable{
    ...
    private UpdateType updateType = UpdateType.LINEAR;
     ...
     */
    public ThreeWheelOdometry(DcMotorEx yLeft, DcMotorEx yRight, DcMotorEx X, double ticksPerDeg,
     ...
     */
    public ThreeWheelOdometry(DcMotor yLeft, DcMotor yRight, DcMotor X,
                              double ticksPerDeg,
                              double robotXInit, double robotYInit,
                              int sleepTime){
        this.x = X;
