...
@Disabled
@Config
public class CandelaSupportAutoRed extends LinearOpMode {
    ...
    Position targetZonePosition = new Position(115,85,90);
    Position starterStackPosition = new Position (103.5,46);
    //PID controller
    ...
    public static double firstAngle = 17;
    public static double secondAngle = 12;
    public static double thirdAngle = 6;//0.5
    public static double EjectSpeedI = 2100;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        printNow();
        waitForStart();
        //odommetry wheel//odometor//dead wheel
        if (tfod != null) {
            tfod.activate();
...
//        ringCase = "Quad";
        ...
        switch(ringCase){
            case "Single":
//                targetZonePosition.setPosition(124,100,-90);
                targetZonePosition.setPosition(87,104,90);
                break;
            case "Quad":
                targetZonePosition.setPosition(113,132,90);
                break;
        }

        ejectMotor(2100,.7);

        positionMove(new Position(94.5 - 15.25,9 + 57.45,firstAngle),3000);
        ...
        switch (ringCase){
            case "null":
                ...
                positionMove(new Position(112,125,70),4000);
                servoUpDown.setPosition(downIndex);
                motorTakeIn_and_Horizontal.setPower(-1);
                driveTrain.speedIndex = 1000;
                positionMove(new Position(46,125,70),3000);
                ejectMotor(2250,.9);
                driveTrain.speedIndex = 2000;
                positionMove(new Position(100.5,64,10),5000);
            ...
            case "Single":
                ...
                positionMove(new Position(100.5,65,10),5000);
                angleCalibration(10,1000);
                motorTakeIn_and_Horizontal.setPower(0);
                sleep(500);
                servoUpDown.setPosition(upIndex);
            ...
            case "Quad":
                ...
                driveTrain.speedIndex =2000;
//                positionMove(new Position(x + 1.5, y - 1.5, -135), 1000);
//
//                motorTakeIn_and_Horizontal.setPower(-1);
//                sleep(500);
//                motorTakeIn_and_Horizontal.setPower(0);
//                sleep(1000);
                ...
                driveTrain.speedIndex =2000;
//                positionMove(new Position(x + 7, y - 7, -135), 1000);
...
//        sleep(500);
        ...
        //回城
        servoDelivery.setPosition(deliveryUpIndex);
        positionMove(new Position(94.5,85,0),1000000);
        angleCalibration(0,1000);
        servoUpDown.setPosition(upIndex);
