...
@Config
@Disabled
public class AuxiliaryBlue extends LinearOpMode {
    ...
    Position targetZonePosition = new Position(13.5,66,-180);
    ...
    PositionalPID positionalPurePursuitPID = new PositionalPID(0.09,0,0,.3,1,2,0);
    //Index
    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch(ringCase){
            case "Single":
                targetZonePosition.setPosition(15,105,90);
                break;
            case "Quad":
                targetZonePosition.setPosition(13.5,111,-180);
                break;
        }
//////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //回城
        Position parkingPosition = new Position (13.5,80.5,0);
        if(ringCase == "null"){
            parkingPosition.setPosition(13.5,57.5,-90);
        }
        ...
        if(ringCase == "null"){
            ...
            parkingPositions.add(new Position(23 + 11.5, 2 * 23 + 11.5));
            parkingPositions.add(new Position(23 + 11.5, 80.5));
