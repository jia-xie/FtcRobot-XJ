...
@Autonomous
@Config
public class AutoBlueTensorFlow extends LinearOpMode {
    ...
    Position targetZonePosition = new Position(23 + 7,4 * 23 - 11,-90);
    Position starterStackPosition = new Position (1.5  * 23,46 + 2);
    Position highGoalLaunchPositionI = new Position(138 - 90,69,24);
    ...
    PositionalPID positionalPurePursuitPID = new PositionalPID(0.06,0,0,.3,1,4,0);
    //Index
...
//
        ...
        switch(ringCase){
            case "Single":
                targetZonePosition.setPosition(2 * 23 + 6,5 * 23 - 9,-90);
                break;
            case "Quad":
                targetZonePosition.setPosition(23 + 4,6 * 23 - 11.5,-135);
                break;
        }
        ...
        followPathWithoutTurningTowards(2000,9, highGoalPathPositions,24,5000,false,2);
        ...
        if(ringCase != "null") {
            switch (ringCase) {
                case "Single":
                    ...
                    positionAccurateMove(1500, ejectPosition, 5000, 1000);
                    angleCalibration(7, 1000);
...
//                    quadLaunchPositions.add(starterStackPosition.getExtendedPosition(25, 0));
//                    quadLaunchPositions.add(starterStackPosition.getExtendedPosition(20, -20));
//                    quadLaunchPositions.add(starterStackPosition.getExtendedPosition(0, -11));
//                    followPathWithoutTurningTowards(1500,4, quadLaunchPositions, 0, 4000, true,4);
//                    positionAccurateMove(2000,quadLaunchPositions.get(quadLaunchPositions.size()-1),2000,1000);

                    positionMove(new Position (starterStackPosition.x + 15, starterStackPosition.y - 12, 0), 3000);
                    positionMove(new Position(starterStackPosition.x, starterStackPosition.y - 12, 0), 2000);

                    //Round 1
                    motorControl(2350, 1, true);
                    positionMove(1000, new Position(starterStackPosition.x, starterStackPosition.y - 3,0), 2000);
                    motorControl(false);
                    positionMove(1000, new Position(odometry.getRobotX(), odometry.getRobotY() + 21), 2000);
...
////                }
////                ringCollectPathPositions = pipeline.getPositionsOfRingsInRange(80,240, odometry.getCurrentPosition());
...
//            }
        ...
        //Parking
        if(ringCase == "null"){
            positionAccurateMove(2000,new Position(3 * 23 - 11.5,80.5,0),3000,2000);
        }else {
            ...
            switch (ringCase) {
                case "Single":
                    parkingPathPositions.add(new Position(2 * 23 + 11.5, 5 * 23 - 11));
                    break;
                case "Quad":
                    parkingPathPositions.add(new Position(2 * 23 + 11.5, 6 * 23 - 11));
                    break;
            }
            parkingPathPositions.add(new Position(2 * 23 + 11.5,80.5));

            followPathWithoutTurningTowards(1500,9,parkingPathPositions,0,5000,false,4);
